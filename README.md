...
- [Download](../../releases/latest/download/map-color-variables.sketchplugin.zip) the latest release of the plugin
- Un-zip
- Double-click on map-color-variables.sketchplugin
